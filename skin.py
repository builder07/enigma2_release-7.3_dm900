...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "PLi-FullNightHD-FIX/skin.xml" or "PLi-HD-FIX/skin.xml"  # SD hardware is no longer supported by the default skin.
